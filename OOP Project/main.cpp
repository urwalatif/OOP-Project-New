...
//				if (checkDate)
//				{
//					for (int i = 0; i < 1; i++) //for single iteration of loop and "i" was required as 0
//					{
...
//							case '1':
//								int cas1 = i + 4;
//								if (obj.registrationTeacher[cas1] == '0' || obj.registrationTeacher[cas1] == '1' || obj.registrationTeacher[cas1] == '2')
//								{
//									checkDayMonth = 1;
//								}
//								else
...
//						case '3':
//							int cas3 = i + 1;
//							if (obj.registrationTeacher[cas3] == '0' || obj.registrationTeacher[cas3] == '1')
//							{
...
//									if (obj.registrationTeacher[cas4] == '0' || obj.registrationTeacher[cas4] == '1' || obj.registrationTeacher[cas4] == '2')
//									{
//										checkDayMonth = 1;
//
//									}
